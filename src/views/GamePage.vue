<template>
  <div class="game-page">
    ...
    <AskAICard v-if="game" class="settings-section" :title="`What is the community saying about this game?`" >
      <p>{{ game.game_performance_summary }}</p>
      <p><i>This is a brief summary of community feedback generated by AI, which can make mistakes.<br/>Please check the community reports for accurate information.</i></p>
    </AskAICard>
